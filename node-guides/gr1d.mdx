...
<AccordionGroup>
  ...
  <Accordion title="What are Circuit Nodes?">
  ...
  <Accordion title="How to setup and run Circuit Nodes?">
  ...
  <Accordion title="Are the NFTs for the Circuit Nodes transferable? If yes, after how long?">
