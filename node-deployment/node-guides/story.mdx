...
<Frame caption="">
  <div id="story-video-container" style={{position: 'relative', width: '100%', height: '400px'}}>
    <div 
      onClick={() => {
        document.getElementById('story-video-container').innerHTML = `
          <iframe width="100%" height="400" src="https://www.youtube.com/embed/e7kGNEao8CY?autoplay=1&mute=1&rel=0" 
      ...
      style={{
        ...
        backgroundImage: 'url(https://img.youtube.com/vi/e7kGNEao8CY/maxresdefault.jpg)',
        backgroundSize: 'cover', backgroundPosition: 'center', borderRadius: '8px'
      }}
    >
      <div id="story-btn" style={{
        ...
        <svg id="story-icon" width="20" height="20" viewBox="0 0 24 24" fill="white">
