...
## FAQ
<AccordionGroup>
  <Accordion title="What is Huddle?">
  ...
  <Accordion title="What is a Media Node?">
  ...
  <Accordion title="How to run Media Node?">
  ...
  <Accordion title="When is TGE?">
    TGE in Q1 2025
  </Accordion>
  
  <Accordion title="Is the NFT transferable?">
    Media Node NFT Key transferrable after 1 year from TGE
  </Accordion>
  
  <Accordion title="What are the daily rewards?">
