...
<Frame caption="">
  <div id="carv-video-container" style={{position: 'relative', width: '100%', height: '400px'}}>
    <div 
      onClick={() => {
        document.getElementById('carv-video-container').innerHTML = `
          <iframe width="100%" height="400" src="https://www.youtube.com/embed/EuWxxL9_dX8?autoplay=1&mute=1&rel=0" 
                  frameBorder="0" allowFullScreen allow="autoplay; encrypted-media" style="border-radius: 8px;"></iframe>
        `;
      }}
      onMouseEnter={() => {
        const btn = document.getElementById('carv-btn');
        const icon = document.getElementById('carv-icon');
      ...
      style={{
        ...
        backgroundImage: 'url(https://img.youtube.com/vi/EuWxxL9_dX8/maxresdefault.jpg)',
        backgroundSize: 'cover', backgroundPosition: 'center', borderRadius: '8px'
      }}
    >
      <div id="carv-btn" style={{
        ...
        <svg id="carv-icon" width="20" height="20" viewBox="0 0 24 24" fill="white">
