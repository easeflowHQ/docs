...
<Frame caption="">
  <div id="sophon-video-container" style={{position: 'relative', width: '100%', height: '400px'}}>
    <div 
      onClick={() => {
        document.getElementById('sophon-video-container').innerHTML = `
          <iframe width="100%" height="400" src="https://www.youtube.com/embed/keSgfBgoMuc?autoplay=1&mute=1&rel=0" 
                  frameBorder="0" allowFullScreen allow="autoplay; encrypted-media" style="border-radius: 8px;"></iframe>
        `;
      }}
      onMouseEnter={() => {
        const btn = document.getElementById('sophon-btn');
        const icon = document.getElementById('sophon-icon');
      ...
      style={{
        ...
        backgroundImage: 'url(https://img.youtube.com/vi/keSgfBgoMuc/maxresdefault.jpg)',
        backgroundSize: 'cover', backgroundPosition: 'center', borderRadius: '8px'
      }}
    >
      <div id="sophon-btn" style={{
        ...
        <svg id="sophon-icon" width="20" height="20" viewBox="0 0 24 24" fill="white">
